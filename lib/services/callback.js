'use strict'
import { ecomAuth } from 'ecomplus-app-sdk'
import * as logger from 'console-files'
...
export const ecomplus = async (request, response) => {
  ecomAuth.then(sdk => {
...
export const wirecard = async (request, response) => {
...
export const requestCallback = (request, response) => {
