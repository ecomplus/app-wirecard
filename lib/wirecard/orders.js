  ...
  return {
    ...
    customer: {
      ...
      shippingAddress: {
        ...
        state: (typeof payload.params.billing_address !== 'undefined') && (typeof payload.params.billing_address.province_code !== 'undefined') ?  payload.params.billing_address.province_code : payload.params.billing_address.province,
