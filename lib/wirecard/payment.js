      ...
      fundingInstrument: {
        ...
        creditCard: {
          ...
          holder: {
            ...
            birthdate: order.params.payer.birth_date.year + '-' + order.params.payer.birth_date.month + '-' + order.params.payer.birth_date.day || order.params.buyer.birth_date.year + '-' + order.params.buyer.birth_date.month + '-' + order.params.buyer.birth_date.day,
            taxDocument: {
              type: order.params.payer.doc_number.length === 11 ? 'CPF' : 'CNPJ',
              number: order.params.payer.doc_number || order.params.buyer.doc_number
            },
            phone: {
