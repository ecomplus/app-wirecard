...
module.exports = {
  new: (customer) => {
    console.log( newCostumerSchema(customer))
...
let newCostumerSchema = (customer) => {
  return {
    ownId: customer.params.buyers.customer_id,
    fullname: customer.params.buyers.fullname,
    ...
    phone: {
      countryCode: customer.params.buyers.phone.country_code,
      areaCode: customer.params.buyers.phone.number.substr(0,2),
      number: customer.params.buyers.phone.number
    },
    shippingAddress: {
